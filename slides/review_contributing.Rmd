...
* time-varying catchability might be helpful for
    ...
    * species that are not observed well by the survey
...
* Think hard about input CVs and age comp sample sizes
    * input samle sizes are particularly important for Dirichlet-Multinomial
...
* Needs 
    * git installed
    * a github account
* You can use git and github through Rstudio, Github Desktop, or many other coding environments
