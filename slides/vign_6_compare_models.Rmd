...
* `do.plot`: produce the comparative plots (default is TRUE)
 ...
 * `region`: Which region to make results for (default = 1)
...
* `wham_location`: (optional) location of WHAM package to use.
* `save_inputs`: T/F whether to save the simulated inputs in res_dir. Default = FALSE.
