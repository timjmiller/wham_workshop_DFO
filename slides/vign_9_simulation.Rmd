...
pre {
  ...
  max-width: 1200px; /*changes width of chunk output box*/
  overflow-x: auto; /* auto will add vertical scroll bar when necessary */
...
* **See the simulation vignette for wham for more details**
---
